...
export const metadata: Metadata = {
  title: "Grandeur Hotel - Luxury 5-Star Hotel Experience",
  description: "Experience luxury redefined at Grandeur Hotel. Premium accommodations, world-class amenities, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, 5-star hotel, premium accommodations, spa, fine dining, concierge service",
  metadataBase: new URL("https://grandeurehotel.com"),
  alternates: {
    canonical: "https://grandeurehotel.com"
  },
  openGraph: {
    title: "Grandeur Hotel - Luxury 5-Star Hotel Experience",
    description: "Experience luxury redefined at Grandeur Hotel. Premium accommodations, world-class amenities, and exceptional service.",
  ...
  twitter: {
    ...
    title: "Grandeur Hotel - Luxury 5-Star Hotel Experience",
    description: "Experience luxury redefined with premium accommodations and world-class service.",
